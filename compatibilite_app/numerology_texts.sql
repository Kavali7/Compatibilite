insert into numerology_texts (type, number, locale, title, body, segment) values
...
('couple', 1, 'fr', NULL, $$Votre rencontre n’a rien d’un hasard. C’est celle de deux flammes au tempérament ardent, 
...
('couple', 2, 'fr', NULL, $$Votre union est une danse douce entre deux âmes qui se reconnaissent avant même de se 
...
('couple', 3, 'fr', NULL, $$Cette relation porte la vibration de l’engagement véritable, celui qui ne se limite pas aux 
...
('couple', 4, 'fr', NULL, $$Votre relation est une œuvre patiente, un édifice bâti pierre après pierre, dans le respect du 
...
('couple', 5, 'fr', NULL, $$Cette relation porte le souffle du vent : imprévisible, vivante, intense et mouvante. Elle ne se 
...
à danser librement.$$, ''),
('couple', 6, 'fr', NULL, $$Couple 6 - Amour protecteur.
...
('couple', 7, 'fr', NULL, $$Votre lien amoureux est de ceux qui échappent aux schémas habituels. Il y a dans votre 
...
('couple', 8, 'fr', NULL, $$Votre relation repose sur des fondations solides, ancrées dans la réalité concrète de la vie. 
...
('couple', 9, 'fr', NULL, $$Votre relation est une rencontre d’âmes anciennes, deux êtres qui se reconnaissent au-delà 
...
('couple', 11, 'fr', NULL, $$Grande sensibilite et intuition commune. Vibration inspiree qui peut guider et apaiser. Risque de stress ou de surcharge emotionnelle. Besoin d ancrage et de mots simples pour rester alignes. Conseil: ritualiser l apaisement et choisir quelques intentions claires.$$, ''),
('couple', 22, 'fr', NULL, $$Puissance de construction a deux. Vision ambitieuse et capacite a structurer sur la duree. Risque de pression et de controle. Besoin de decouper, de se relayer et de garder l etique. Conseil: clarifier les roles et celebrer chaque jalon.$$, ''),
('couple', 33, 'fr', NULL, $$Chaleur, service et inspiration elevee. Envie d aider et de motiver ensemble. Risque de sur-responsabilisation ou d ideal trop lourd. Besoin de limites et de joie simple. Conseil: proteger l energie avant d aider, et garder du temps ludique.$$, ''),
('couple_deep', 1, 'fr', NULL, $$Couple 1 - Feu sacre et leadership.
...
('couple_deep', 2, 'fr', NULL, $$Couple 2 - Douceur, soutien, harmonie.
...
('couple_deep', 3, 'fr', NULL, $$Couple 3 - Engagement et co-creation.
...
('couple_deep', 4, 'fr', NULL, $$Couple 4 - Batisseurs stables.
...
('couple_deep', 5, 'fr', NULL, $$Couple 5 - Liberte et aventure.
...
('couple_deep', 6, 'fr', NULL, $$Couple 6 - Amour protecteur.
...
('couple_deep', 7, 'fr', NULL, $$Couple 7 - Lien mystique et evolutif.
...
('couple_deep', 8, 'fr', NULL, $$Couple 8 - Pouvoir et prosperite.
...
('couple_deep', 9, 'fr', NULL, $$Couple 9 - Union humaniste et universelle.
...
('couple_deep', 11, 'fr', NULL, $$Forces: intuition partagee, sensibilite elevee, perception fine des ambiances. Grande creativite, inspiration spirituelle ou artistique. Capacite a apaiser et a guider avec douceur.
...
('couple_deep', 22, 'fr', NULL, $$Forces: maitre batisseur a deux: vision ambitieuse, structure solide, endurance. Grande capacite a federer et a materialiser des projets importants.
...
('couple_deep', 33, 'fr', NULL, $$Forces: service et inspiration elevee partagee. Chaleur, empathie, capacite a encourager et a apaiser. Rayonnement positif sur l entourage.
